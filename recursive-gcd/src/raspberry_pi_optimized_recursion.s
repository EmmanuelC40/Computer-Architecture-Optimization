...
.LFE2023:
	...
	.text
	.align	2
	.global	_Z10gcd_recursii
	.type	_Z10gcd_recursii, %function
_Z10gcd_recursii:
        .cfi_startproc
    stp	x29, x30, [sp, -16]!
    mov	x29, sp
...
.Ldone:
	...
	.cfi_endproc
.LFE2046:
	.size	_Z10gcd_recursii, .-_Z10gcd_recursii
...
.LFB2047:
	...
	.cfi_offset 19, -64
	mov	w0, 56896
	movk	w0, 0x2d2, lsl 16
	str	w0, [sp, 76]
	mov	w0, 9520
	movk	w0, 0x120, lsl 16
	str	w0, [sp, 72]
	...
	str	x0, [sp, 56]
	add	x0, sp, 56
	bl	_ZNSt6chrono13duration_castINS_8durationIlSt5ratioILl1ELl1000000000EEEElS3_EENSt9enable_ifIXsrNS_13__is_durationIT_EE5valueES7_E4typeERKNS1_IT0_T1_EE
	str	x0, [sp, 32]
	adrp	x0, .LC0
	add	x1, x0, :lo12:.LC0
...
.LFB2339:
	...
	str	x0, [sp, 24]
	ldr	x0, [sp, 24]
	bl	_ZNSt6chrono20__duration_cast_implINS_8durationIlSt5ratioILl1ELl1000000000EEEES2_ILl1ELl1EElLb1ELb1EE6__castIlS3_EES4_RKNS1_IT_T0_EE
	ldp	x29, x30, [sp], 32
	.cfi_restore 30
	.cfi_restore 29
	.cfi_def_cfa_offset 0
...
.LFE2627:
	...
	.align	2
	.type	_GLOBAL__sub_I__Z10gcd_recursii, %function
_GLOBAL__sub_I__Z10gcd_recursii:
.LFB2628:
	.cfi_startproc
	stp	x29, x30, [sp, -16]!
	.cfi_def_cfa_offset 16
	...
	.cfi_endproc
.LFE2628:
	.size	_GLOBAL__sub_I__Z10gcd_recursii, .-_GLOBAL__sub_I__Z10gcd_recursii
	.section	.init_array,"aw"
	.align	3
	.xword	_GLOBAL__sub_I__Z10gcd_recursii
	.hidden	__dso_handle
